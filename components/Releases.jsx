  ...
  render() {
    return (
      ...
      <div id="releases" className="content box main-item">
        ...
        <img id="top-right-flourish-releases" className="top-right flourish releases-item" src="./imgs/red-corner-zoe-emery.png" alt="flourish"/>
        ...
        <img id="bottom-left-flourish-releases" className="bottom-left flourish releases-item" src="./imgs/red-corner-zoe-emery.png" alt="flourish"/>
      </div>
    )
  }
}
