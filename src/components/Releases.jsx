...
class Releases extends React.Component {
  ...
  render() {
    return (
      ...
      <div id="releases" className="content box main-item item">
        <h2 id="releases-title"className="releases-item item">ALL RELEASES</h2>
        <img id="top-right-flourish-releases" className="top-right flourish" src="./imgs/red-corner-zoe-emery.png" alt="flourish"/>
        <a id="dl-link-eris-eros" href="./music/darkBeat.mp3" className="download downloads-item item" download>
          <img id="eris-eros" className="releases-img" src="./imgs/zoe-emery-eris-eros.jpeg" alt="Eris Eros"/>
        </a>
        <a id="dl-link-eris-eros-2" href="./music/darkBeat.mp3" className="download downloads-item item" download>
          <img id="eris-eros-pt-2" className="releases-img" src="./imgs/zoe-emery-eris-eros.jpeg" alt="Eris Eros, Pt. 2"/>
        </a>
        <a id="dl-link-hydrochloria" href="./music/darkBeat.mp3" className="download downloads-item item" download>
